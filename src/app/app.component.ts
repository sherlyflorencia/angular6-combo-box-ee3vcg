...
export class AppComponent {
  ...
  constructor() {
    ...
    this.vegetableList = [
      { "vegName": "veg1", "code": "AF" },
      { "vegName": "veg2", "code": "AX" },
      { "vegName": "veg3", "code": "AL" },
      { "vegName": "veg4", "code": "DZ" },
      { "vegName": "veg5", "code": "AS" }
    ];
    //     this.dataList = [
    // {"name": "Afghanistan", "code": "AF"},
    // {"name": "Åland Islands", "code": "AX"},
  ...
  //   this.dummyDataList = [];
  //   if (country.length > 0) {
  //     this.dummyDataList = this.countryFilter.transform(this.dataList, country);
